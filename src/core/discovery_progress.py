...
class SpaProgress:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "current_component": self.current_component.to_dict() if self.current_component else None,
        ...
        with self._lock:
            ...
            for component in spa.components:
                if component.component_id == component_id:
                    ...
                    component.phase = DiscoveryPhase.FAILED if error else DiscoveryPhase.COMPLETED
                    if example_info:
                        component.example_info = example_info
                    if error:
            ...
            if spa.current_component and spa.current_component.component_id == component_id:
