...
discovery_state = load_module(
    "discovery_state", src_dir / "core" / "discovery_state.py"
)
background_discovery = load_module(
    "background_discovery", src_dir / "core" / "background_discovery.py"
)
discovery_coordinator = load_module(
    "discovery_coordinator", src_dir / "core" / "discovery_coordinator.py"
)
